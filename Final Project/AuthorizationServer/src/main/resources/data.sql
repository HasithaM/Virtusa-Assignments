...
('cardoor', '{bcrypt}$2y$12$4LLQ2RV1jfHKLSJPlQjokO4nsilrAN1QkmxflUZMJfddzCNQQW3tC', 'http://localhost:8080/code',
...
('1', 'hasitha','{bcrypt}$2a$10$YmBtJn2wYMkAdg0yYV2KTODWExj.CCD/evbP7qghRqUk7JZqlLa0K', 'hasitha@no.com', '1', '1', '1', '1');
INSERT INTO user (id, username, password, email, enabled, accountNonExpired, credentialsNonExpired, accountNonLocked) VALUES
